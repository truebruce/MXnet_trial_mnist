...
net = GenerateConvolutionalLayers(data, (3,3), 16, 'relu', 'Conv_1')
net = GenerateConvolutionalLayers(net, (3,3), 16, 'relu', 'Conv_1_2')
...
net = GenerateConvolutionalLayers(net, (3,3), 32, 'relu', 'Conv_2')
net = GenerateConvolutionalLayers(net, (3,3), 32, 'relu', 'Conv_2_2')
